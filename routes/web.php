...
Route::post('/login/check', [MainController::class, 'validateLogin'])->name('validate');
...
Route::group(['middleware' => ['UserSession']], function(){
    ...
    Route::get('/print/employeeAll', [EmployeeController::class, 'exportEmployee'])->name('employeeReport');
    Route::get('/print/creditAll', [CreditController::class, 'exportCredit'])->name('creditReport');
