                ...
                <form class="form" id="form-add" method="POST">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <select id="sumber_dana" name="sumber_dana" class="form-control" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="Sumber Dana" data-original-title="" title="">
...
{{-- Modal Add Masuk--}}
<div class="modal fade text-left" id="modal-add-keluar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-info">
                <h5 class="modal-title text-white" id="modal-title"></h5>
            ...
            <div class="modal-body">
                <form class="form" id="form-add-keluar" method="POST">
                    @csrf
                    <div class="form-body">
                        <div class="form-group">
                            <label for="tanggal" class="font-weight-bold">Tanggal</label>
                            <input type="hidden" name="id_keluar" id="id_keluar" class="form-control" value="">
                            <input type="hidden" name="action_keluar" id="action_keluar" class="form-control">
                            <input type="date" id="tanggal_keluar" class="form-control" name="tanggal_keluar" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="Tanggal Input" data-original-title="" title="">
                        </div>
                        <div class="form-group">
                            <label for="dana" class="font-weight-bold">Dana</label>
                            {{-- <select id="dana" name="dana" class="form-control" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="Dana" data-original-title="" title="">
                            ...
                            <input type="text" class="form-control" id="dana_keluar" name="dana_keluar" data-placement="top" data-title="Dana" value="keluar" readonly>
                        </div>
                        <div class="form-group">
                            <label for="sumber-dana" class="font-weight-bold">Sumber Dana</label>
                            <select id="sumber_dana_keluar" name="sumber_dana_keluar" class="form-control" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="Sumber Dana" data-original-title="" title="">
                            <option value="1">Kas Bank</option>
                            <option value="2">Kas Besar</option>
                            <option value="3">Kas Kecil</option>
                            </select>
                        ...
                        <div class="form-group">
                            <label for="bank" class="font-weight-bold">Bank</label>
                            <select id="bank_id_keluar" name="bank_id_keluar" class="form-control" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="Bank" data-original-title="" title="">
                                @foreach ($bank as $dt)
                                    <option value="{{ $dt->id }}">{{ $dt->nama_bank }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control jum" type-currency="IDR" placeholder="Jumlah" aria-label="Amount (to the nearest dollar)" id="jumlah_keluar" name="jumlah_keluar">
                                {{-- <div class="input-group-append">
                                <span class="input-group-text">.00</span>
                                </div> --}}
                            </div>
                        ...
                        <div class="form-group">
                            <label for="keterangan" class="font-weight-bold">Keterangan</label>
                            <textarea id="keterangan_keluar" rows="5" class="form-control" name="keterangan_keluar" placeholder="Keterangan" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="keterangan" data-original-title="" title=""></textarea>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
...
<script>
    ...
    $(document).ready(function () {
        $('#tbl_kas_keluar').DataTable({
            ...
            columns: [{
                ...
                {data: 'tanggal', name: 'tanggal_keluar'},
                {data: 'dana', name: 'dana_keluar'},
                {data: 'sumber_dana', name: 'sumber_dana_keluar'},
                {data: 'bank_id', name: 'bank_id_keluar'},
                {data: 'jumlah', name: 'jumlah_keluar'},
                {data: 'keterangan', name: 'keterangan_keluar'},
                {data: 'aksi', name: 'aksi'},
            ]
        });
    });
    ...
    /* FUnction Tambah */
    $(document).on('click', '#btn-add-keluar', function () {
        $('#modal-add').modal('show');
        $('#modal-title').html('Tambah Data Keluar');
        $('.btn-action').html('Simpan');
